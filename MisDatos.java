...
public class MisDatos 
{
     ...
     * @param nombre Nombre que ha introducido el usuario y que indica el nombre que tiene. Minimo debe tener 3 carácteres.
     */
     ...
     * @param Apellido que ha introducido el usuario y que indica el primero apellido que tiene. Minimo debe tener 2 carácteres.
     */
     ...
     * @param Apellido que ha introducido el usuario y que indica el segundo Apellido que tiene. Minimo debe tener 2 carácteres.
     */
     ...
     * <br>Si son 8 dígitos calculará la letra asociada, y si no directamente lo asigna
     ...
     * <br>Para ello, toma las dos primeras letras del segundo Apellido, a continuación coge las dos primeras del primer Apellido y por Último coge las tres primeras letras del nombre. 
     */
    ...
    public boolean comprobarPrimerApellido(String primerApellido)
    {
        ...
        {
            System.out.println("Debe tener más de 2 caracteres");
            return false;
        }
     ...
     * Para ello, comprueba que tenga un minimo de 8 carácteres, que es la cantidad de numeros que tiene el documento de identidad español.
     * <br>Si los tiene, pasará a comprobar si todos estos carácteres son digitos, no pudiendo tener alguna letra entre medias.
     * <br>En caso de que tenga 9 carácteres, se comprobará que se trata de la letra asociada al numero de DNI. 
     ...
     * @param DNI Número asociado a la variable DNI del usuario sobre el que se está creando la contraseña.
     ...
     * <br>En caso de que se encuentre en ese formato, comprobará que se trate de una fecha anterior a la de hoy.
